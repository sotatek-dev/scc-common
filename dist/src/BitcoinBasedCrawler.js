...
exports.BitcoinBasedCrawler = void 0;
var BaseCrawler_1 = __importDefault(require("./BaseCrawler"));
var registries_1 = require("./registries");
var Logger_1 = require("./Logger");
var Utils = __importStar(require("./Utils"));
var logger = Logger_1.getLogger('BitcoinBasedCrawler');
var BitcoinBasedCrawler = (function (_super) {
    __extends(BitcoinBasedCrawler, _super);
    function BitcoinBasedCrawler() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BitcoinBasedCrawler.prototype.processBlocks = function (fromBlock, toBlock, latestNetworkBlock) {
                        ...
                        return [4, Utils.PromiseAll(allCurrencies.map(function (c) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            allTxs = _a.sent();
                                            roundCounter = Math.ceil(allTxs.length / 5000);
                                            round = Array.from(Array(roundCounter).keys());
                                            _i = 0, round_1 = round;
                                            _a.label = 2;
                                        case 2:
                                            if (!(_i < round_1.length)) return [3, 5];
                                            r = round_1[_i];
                                            allTxsInRound = allTxs.slice(r * 5000, (r + 1) * 5000);
                                            return [4, this._options.onCrawlingTxs(this, allTxsInRound)];
                                        case 3:
                                            _a.sent();
                                            _a.label = 4;
                                        case 4:
    ...
    return BitcoinBasedCrawler;
}(BaseCrawler_1.default));
exports.BitcoinBasedCrawler = BitcoinBasedCrawler;
//# sourceMappingURL=BitcoinBasedCrawler.js.map